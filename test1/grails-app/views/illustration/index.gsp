            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th scope="col">Sale Ad</th>
                    </tr>
                </thead>
                <tbody>
                    <g:each in="${illustrationList}" var="illustration">
                        <tr>
                            <th scope="row"><img src="https://picsum.photos/200/300"></img></th>
                            <td><a href="/tpmbds/saleAd/show/${illustration.saleAd.id}">${illustration.saleAd}</a></td>
                        </tr>
                    </g:each>
                </tbody>
            </table>
